<template>
  <div class="app-container">
    ...
    <el-button type="text" @click="openChapterDialog()">Add章节</el-button>
    ...
    <ul class="chanpterList">
      <li v-for="chapter in chapterVideoList" :key="chapter.id">
        <p>
          {{ chapter.title }}
          <span class="acts">
            <el-button style type="text" @click="openVideo(chapter.id)">Add小节</el-button>
    ...
    <!-- Add和修改章节表单 -->
    <el-dialog :visible.sync="dialogChapterFormVisible" title="Add章节">
    ...
    <!-- Add和修改课时表单 -->
    <el-dialog :visible.sync="dialogVideoFormVisible" title="Add课时">
...
export default {
  ...
  methods: {
    ...
    beforeVodRemove(file, fileList) {
      return this.$confirm(`Yes移除 ${file.name}？`);
    },
    //上传视频成功调用的方法
    ...
    //删除小节
    removeVideo(id) {
      this.$confirm("此Action将删除小节, 是否继续?", "Alert", {
    ...
    removeChapter(chapterId) {
      this.$confirm("此Action将删除章节, 是否继续?", "Alert", {
        confirmButtonText: "Yes",
        cancelButtonText: "No",
        type: "warning"
      }).then(() => {
